package com.diarra.systeme.config;
...
import com.diarra.systeme.config.jwt.JwtAuthenticationEntryPoint;
import com.diarra.systeme.config.jwt.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   protected void configure(HttpSecurity httpSecurity) throws Exception {
      ...
      // dont authenticate this particular request
           ...
           .antMatchers(HttpMethod.POST, "/remark/addRemark").permitAll()
           .antMatchers(HttpMethod.GET, "/remark/getRemarks").permitAll()
